...
const EfficiencyComponent = () => {
  return (
    <div className="flex flex-col ">
      <div className="bg-white rounded-lg px-8 py-12 flex flex-col md:flex-col justify-between">
        ...
        <div className="flex items-center justify-center mt-4">
          ...
          <div className="flex max-w-sm mr-auto relative">
            ...
            <div className="relative rounded-full w-24 h-24 bg-gray-200 flex items-center justify-center shadow-md z-10">
              <div className="w-10 h-10 bg-red-500 rounded-xl flex items-center justify-center">
                <CiWavePulse1 className="text-white text-3xl font-bold" />
              </div>
            </div>
            {/* Right Circle with Text */}
            <div className="bg-yellow-400 rounded-full w-24 h-24 flex flex-col items-center text-black absolute top-0 left-20">
              <div className="pt-4">
          ...
          {/* Text Component */}
          <div className="bg-yellow-400 rounded-[2rem] text-5xl md:text-8xl">
            lytics serv
          </div>
        </div>
      </div>
      {/* call to action */}
      {/* Text Section */}
      <hr className="border-t-[1px] border-gray-300 w-[90%] mt-12 mb-10 mx-auto" />
      ...
      <div className="bg-white py-12 px-6 md:py-16 md:px-12 lg:px-24 flex flex-col md:flex-row items-end justify-between">
        ...
        {/* Buttons Section */}
        <div className="flex">
          <button className="bg-gray-200 border border-gray-200 rounded-lg text-xs py-1 px-4 hover:bg-gray-100">
            Request a demo
          </button>
          <button className="bg-[#F25922] text-white rounded-lg text-xs ml-1 py-1 px-4 hover:bg-[#d14a1a]">
            Start for free
          </button>
        </div>
      </div>
